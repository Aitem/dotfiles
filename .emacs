...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (lua-mode dockerfile-mode docker markdown-mode neotree helm-ag ag exec-path-from-shell popwin evil-magit dashboard auto-complete-auctex auto-complete ivy window-layout nlinum evil-paredit paredit company-web helm-descbinds projectile magit cider clojure-mode 4clojure company evil-escape helm evil)))
